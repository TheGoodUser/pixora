...
\- for network access while development use command :-
`adb reverse tcp:8000 tcp:8000`

the backend repo is https://github.com/TheGoodUser/pixora-backend

where run below commands to install and set it up
1. `chmod +x ./init.sh`
2. `sudo ./init.sh`
For more details visit the backend repo
